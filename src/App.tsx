            ...
            <div className="relative z-10 md:text-center lg:text-left ">
              ...
              <div className="relative leading-10">
                ...
                <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                  ...
                  <a target='_blank' className="rounded-full bg-amber-500 py-2 px-4 text-sm font-semibold text-black hover:bg-[#FF7841]focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-300/50 active:bg-[#FF7841]" href={'https://www.pathbtc.com/PATH_whitepaper.pdf'}>White Paper</a>
