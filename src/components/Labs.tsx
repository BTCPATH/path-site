    ...
    return <>
        <article>
            <header className="mb-9 space-y-1">
                <p className="font-display text-sm font-medium text-[#FF7841]">Others welcome partners</p>
                <h1 className="font-display text-3xl tracking-tight text-slate-900 dark:text-white">Organization /Labs/ project side</h1>
            </header>
